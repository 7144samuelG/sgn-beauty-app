...
import Hairr from "../components/Categories5";
import CategoriesCF4 from "../components/FaceCat4";
...
const Hair = () => {
  ...
  const item = {
    id: 12,
    name: "Hair Gyl",
    image: require("../assets/beauty/h4.jpg"),
    price: 28,
    description:
  ...
  return (
    <SafeAreaView style={tw`mt-[40px] px-2`}>
      ...
      <View style={tw`flex-row justify-between items-center px-2 mt-[50px]`}>
          ...
          <Text style={tw`text-[24px]`}>Hair Products</Text>
          <TouchableOpacity
        ...
        <View>
          ...
          <View style={tw`flex-row`}>
            ...
            >
              <Image
                source={require("../assets/beauty/h4.jpg")}
              ...
              <Text style={tw`ml-2 text-[15px]`}>$28</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
