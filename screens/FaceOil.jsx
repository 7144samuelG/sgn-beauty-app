    ...
    <SafeAreaView style={tw`mt-[40px] px-2`}>
      ...
      <View style={tw`flex-row justify-between items-center px-2 mt-[60px]`}>
        <TouchableOpacity onPress={() => navigation.navigate("Profile")}>
          ...
          <Text style={tw`text-[24px]`}>Face Products</Text>
          <TouchableOpacity onPress={()=>navigation.navigate("Cart")} style={tw`relative`} >
        ...
        <View>
          ...
          <View style={tw`flex-row`}>
            ...
            >
              ...
              <Text style={tw`ml-2 text-[15px]`}>$49</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
