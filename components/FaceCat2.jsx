        ...
        <ScrollView horizontal={true}>
          <View style={tw`flex-row pr-3 justify-between items-center pl-3`}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Skin")}>
              <Text
                style={tw` bg-black text-white py-4 px-7 rounded-[20px] mr-2 text-[20px]`}
              >
                Skin
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Hair")}>
              <Text style={tw`bg-blue-200 py-4 px-7 rounded-[20px] text-[20px]`}>
                Hair
              </Text>
            </TouchableOpacity>
